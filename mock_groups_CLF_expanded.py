...
def main():
    ...
    ax=axes[1]
    p1 = ax.errorbar(bin_centers,phi_2,yerr=phi_err_2, fmt='o', color='black', ms=4, mec='none')
    ax.legend([p1a],['mock'], frameon=False, fontsize=10, numpoints=1)
    ax=axes[2]
    p1 = ax.errorbar(bin_centers,phi_3,yerr=phi_err_3, fmt='o', color='black', ms=4, mec='none')
    
    #centrals
    ax=axes[3]
    p2 = ax.errorbar(bin_centers,phi_red_cen_1, yerr=phi_red_cen_err_1, fmt='o', color='red', ms=4, mec='none')
    p3 = ax.errorbar(bin_centers,phi_blue_cen_1, yerr=phi_blue_cen_err_1, fmt='o', color='blue', ms=4, mec='none')
    ax.legend([p2,p3],['red group centrals','blue group centrals'], frameon=False, fontsize=10, numpoints=1)
    ax=axes[4]
    ax.errorbar(bin_centers,phi_red_cen_2, yerr=phi_red_cen_err_2, fmt='o', color='red', ms=4, mec='none')
    ax.errorbar(bin_centers,phi_blue_cen_2, yerr=phi_blue_cen_err_2, fmt='o', color='blue', ms=4, mec='none')
    ax.legend([p2a,p3a],['red mock centrals','blue mock centrals'], frameon=False, fontsize=10, numpoints=1)
    ax=axes[5]
    ax.errorbar(bin_centers,phi_red_cen_3, yerr=phi_red_cen_err_3, fmt='o', color='red', ms=4, mec='none')
    ax.errorbar(bin_centers,phi_blue_cen_3, yerr=phi_blue_cen_err_3, fmt='o', color='blue', ms=4, mec='none')
    
    #satellites
    ax=axes[6]
    p4 = ax.errorbar(bin_centers,phi_red_sat_1, yerr=phi_red_sat_err_1, fmt='o', color='red', ms=4, mec='none')
    p5 = ax.errorbar(bin_centers,phi_blue_sat_1, yerr=phi_blue_sat_err_1, fmt='o', color='blue', ms=4, mec='none')
    ax.legend([p4,p5],['red group satellites','blue group satellites'], frameon=False, fontsize=10, numpoints=1)
    ax=axes[7]
    ax.errorbar(bin_centers,phi_red_sat_2, yerr=phi_red_sat_err_2, fmt='o', color='red', ms=4, mec='none')
    ax.errorbar(bin_centers,phi_blue_sat_2, yerr=phi_blue_sat_err_2, fmt='o', color='blue', ms=4, mec='none')
    ax.legend([p4a,p5a],['red mock satellites','blue mock satellites'], frameon=False, fontsize=10, numpoints=1)
    ax=axes[8]
    ax.errorbar(bin_centers,phi_red_sat_3, yerr=phi_red_sat_err_3, fmt='o', color='red', ms=4, mec='none')
    ax.errorbar(bin_centers,phi_blue_sat_3, yerr=phi_blue_sat_err_3, fmt='o', color='blue', ms=4, mec='none')
