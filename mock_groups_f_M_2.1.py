...
def main():
    ...
    centrals_bool   = np.array(mock['ID_host']==-1)
    satellites_bool = np.array(mock['ID_host']!=-1)
    ...
    f_red_cen = f_prop(mock['M_host'],bins,red,blue,centrals_bool)
    f_red_sat = f_prop(mock['M_host'],bins,red,blue,satellites_bool)
    f_sat_red = f_prop(mock['M_host'],bins,satellites,centrals,red_bool)
    f_sat_blue = f_prop(mock['M_host'],bins,satellites,centrals,blue_bool)
    ...
    ax=axes[3]
    p3a=ax.errorbar(bin_centers, f_sat_red, yerr=err_sat_red,fmt='o',color='red', mec='none', ms=3)
    p4a=ax.errorbar(bin_centers, f_sat_blue, yerr=err_sat_blue,fmt='o',color='blue', mec='none', ms=3)
    ax.legend((p1b,p2b),('halo red','halo blue'), loc='lower right', fontsize=10, numpoints=1, frameon=False)
    ...
    p3a=ax.errorbar(bin_centers, f_sat_red, yerr=err_sat_red,fmt='o',color='red', mec='none', ms=3)
    p4a=ax.errorbar(bin_centers, f_sat_blue, yerr=err_sat_blue,fmt='o',color='blue', mec='none', ms=3)
    ax.legend((p3a,p4a),('groups red','groups blue'), loc='lower right', fontsize=10, numpoints=1, frameon=False)
