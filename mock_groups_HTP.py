...
def plot_htp(H_cc, H_sc, H_ss, H_cs, mass_bins):
    ...
    ax.set_ylabel(r'$\log(M_{\rm halo}) [M_{\odot}h^{-1}]$')
    ax.set_title('group centrals')
    ax.text(13.25,11.5,r'(i) cen $\mapsto$ cen', color='black')
    ...
    ax.text(11.5,14.5,r'(ii) sat $\mapsto$ sat', color='black')
    ...
    ax.text(13.25,11.5,r'(iii) sat $\mapsto$ cen', color='black')
    ...
    ax.xaxis.set_ticklabels([])
    ax.set_yticks([11.5,12,12.5,13,13.5,14,14.5])
    ax.text(11.5,14.5,r'(iv) cen $\mapsto$ sat', color='black')
    ...
    hist_1_ax.set_ylabel('P')
    hist_1_ax.set_xlabel(r'$\log(M_{\rm group}) [M_{\odot}h^{-1}]$')
    ...
    hist_2_ax.set_xlabel(r'$\log(M_{\rm group}) [M_{\odot}h^{-1}]$')
